-- 14. Выдавать возможно ли положить предмет на склад
...
-- 16. Вставлять траты на предметы
...
--12. Выдача дохода за определенный период при изменении цены предметов, участвующих в создании пунктов меню 
